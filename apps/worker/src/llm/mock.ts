...
export function mockGenerateProduct(args: {
  ...
  return {
    ...
    keyJudgments: [
      "This is a mock-generated product for development/testing.",
      "All claims are derived only from the provided evidence references.",
      "Analytic confidence is computed separately from likelihood.",
    ],
    ...
    changeFromLast: args.requireChangeFromLast ? "No prior product available in mock mode." : undefined,
  };
}
