...
- [x] Fix any failing tests on main/PRs so AMD CI is green by default (start with alerts-core if failing). (Normalized alert timestamp handling to prevent whitespace-caused failures.)
